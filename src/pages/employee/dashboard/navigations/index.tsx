...
import { navigations } from "@/lib/employee/employeeNav";
...
const EmployeeNavigations: React.FC<NavProps> = ({ navIsOpen }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {navIsOpen ? (
          <h4 className="mt-6 pl-2 text-sm opacity-50">EMPLOYEE</h4>
        ) : (
